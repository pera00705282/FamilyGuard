...
The default deployment path is `/var/www/crypto-trading`. Update the `DEPLOY_PATH` in the workflow file if needed.
...
echo "📝 Please check CI_CD_SETUP.md for next steps to configure your repository."